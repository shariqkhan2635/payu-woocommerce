...
define('PAYU_ADDRESS_API_URL_UAT', 'https://apitest.payu.in/user/address/v2');
define('PAYU_ADDRESS_API_URL', 'https://apitest.payu.in/user/address/v2');
define('PAYU_GENERATE_API_URL', 'https://uat-accounts.payu.in/oauth/token');
define('PAYU_GENERATE_API_URL_UAT', 'https://uat-accounts.payu.in/oauth/token');
define('PAYU_CLIENT_ID', '68b9ee63744ba405dc4a013ec9a80d4f9eef4a859c9f04468ddec5c1a35f33f3');
define('PAYU_CLIENT_SECRET_ID', '98930aa1b9e717009d51b3492bf635659d3bd95b08e0d243aae23b2df5efa7e2');
